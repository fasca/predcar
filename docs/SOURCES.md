...
| RDW Gekentekende voertuigen (`m9d7-ebf2`) | NL | CC0 1.0 | https://opendata.rdw.nl/resource/m9d7-ebf2.json | — | Requête agrégée SoQL (`docs/sources/rdw_nl.md`) ; **à vérifier par HTTP** (opendata.rdw.nl inaccessible depuis l'environnement de dev initial) |
